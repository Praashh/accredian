...
const Refer = () => {
    return (
        <div className="relative shadow-lg flex flex-col-reverse md:flex-row items-center shadow-slate-500 md:w-[60vw] w-[90vw] h-[50vh] md:h-[60vh] bg-[#1A73E826] rounded-3xl overflow-hidden">
            <img src={moneyLeft} alt="moneyleft" className="absolute left-0 top-11 md:left-3 md:top-0 z-0" />
            <div className="flex flex-col justify-center items-start gap-2 md:gap-7 h-full w-[48%] px-16 mr-8 relative z-10">
                <h2 className="text-lg md:text-5xl text-[rgb(26,32,44)] font-bold">Let’s Learn & Earn</h2>
                <div>
                    <p className="text-lg text-[#1A202C] md:text-3xl">Get a chance to win</p>
                    <p className="text-lg text-[#1A202C] md:text-3xl">up-to <span className="text-lg md:text-4xl text-[#1A73E8]">Rs.15,000</span></p>
                </div>
            ...
            <img src={moneyRightCenter} alt="moneyright" className="absolute right-0 top-11 md:left-[51%] md:top-[6%] -z-10" />
        </div>
    );
};
